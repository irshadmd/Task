        ...
        <div class="row">
            <div class="col-md-6">
                <div class="signup-img">
                    <img src="asset/img/signupimg.svg" alt="" srcset="" height="550px" width="300px">
                </div>
            </div>
            <div class="col-md-6">
                    ...
                    <form class="login100-form validate-form" action="signup_data.php" method="POST">
                        ...
                        if (isset($_SESSION['success'])) {
                            echo "
									...
									<p style='color:white' >" . $_SESSION['success'] . "</p>
								</div>
								";
                        ...
                        <div class="container-login100-form-btn">
                            <button type="submit" name="signup" class="login100-form-btn"> &nbsp Signup</button>
                        </div>
                        <br>
                        <div class="container-login100-form-btn">
                            <a href="login.php" class="login100-form-btn">Already registered? Login!</a>
                        </div>
                    </form>
                </div>
            </div>
